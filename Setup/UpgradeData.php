...
class UpgradeData implements UpgradeDataInterface
{
    ...
    public function upgrade(
        ...
        //Your upgrade script
            ...
            $setup->getConnection()->query("INSERT INTO `workflow_component_schedule_relation` (`workflowcomponentschedulerelation_id`, `schedule_id`, `asynchron`, `component_id`, `position`, `parameters`) VALUES (5, 3, 0, 3, 1, '{\"order_status\":\"processing\",\"export_path\":\"/var/nav/export/order/\"}');");
