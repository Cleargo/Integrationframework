...
class UpgradeData implements UpgradeDataInterface
{
    ...
    public function upgrade(
        ...
        //Your upgrade script
            ...
            $setup->getConnection()->query("INSERT INTO `workflow_component_schedule_relation` (`workflowcomponentschedulerelation_id`, `schedule_id`, `asynchron`, `component_id`, `position`, `parameters`) VALUES (7, 4, 0, 6, 1, '{\"creditmemo_status\":\"confirmed\",\"export_path\":\"/var/export_creditmemo/\"}');");
