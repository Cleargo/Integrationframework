...
class UpgradeData implements UpgradeDataInterface
{
    ...
    public function upgrade(
        ...
        //Your upgrade script
            ...
            $setup->getConnection()->query("INSERT INTO `workflow_component_definition_parameters` (`workflowcomponentdefinitionparameters_id`, `component_id`, `name`, `type`, `required`, `enum_values`) VALUES (15, 6, 'creditmemo_status', 'enum', 1, '{\"enumValues\":[\"all\",\"confirmed and paid\"]}');");
            $setup->getConnection()->query("INSERT INTO `workflow_component_definition_parameters` (`workflowcomponentdefinitionparameters_id`, `component_id`, `name`, `type`, `required`, `enum_values`) VALUES (16, 6, 'export_path', 'text', 1, NULL);");
            ...
            $setup->getConnection()->query("INSERT INTO `workflow_component_schedule_relation` (`workflowcomponentschedulerelation_id`, `schedule_id`, `asynchron`, `component_id`, `position`, `parameters`) VALUES (8, 4, 0, 4, 2, '{\"ftp_host\":\"ftp://128.12.123.12\",\"ftp_user\":\"cleargo\",\"ftp_pw\":\"test123\",\"secure_type\":\"no-ssl\",\"file_pattern\":\"^shipment_[Ymd.xml\"}');");
