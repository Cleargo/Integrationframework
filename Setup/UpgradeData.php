...
class UpgradeData implements UpgradeDataInterface
{
    ...
    public function upgrade(
        ...
        //Your upgrade script
            ...
            $setup->getConnection()->query("INSERT INTO `workflow_component_definition_parameters` (`workflowcomponentdefinitionparameters_id`, `component_id`, `name`, `type`, `required`, `enum_values`) VALUES (10, 2, 'export_path', 'text', 1, NULL);");
