...
class UpgradeData implements UpgradeDataInterface
{
    ...
    public function upgrade(
        ...
        //Your upgrade script
            ...
            $setup->getConnection()->query("INSERT INTO `workflow_component_definition_parameters` (`workflowcomponentdefinitionparameters_id`, `component_id`, `name`, `type`, `required`, `enum_values`) VALUES (14, 4, 'upload_path', 'text', 1, NULL);");
            $setup->getConnection()->query("INSERT INTO `workflow_component_definition_parameters` (`workflowcomponentdefinitionparameters_id`, `component_id`, `name`, `type`, `required`, `enum_values`) VALUES (15, 5, 'reindex', 'int', 0, NULL);");
            $setup->getConnection()->query("INSERT INTO `workflow_component_definition_parameters` (`workflowcomponentdefinitionparameters_id`, `component_id`, `name`, `type`, `required`, `enum_values`) VALUES (16, 6, 'creditmemo_status', 'enum', 1, '{\"enumValues\":[\"all\",\"confirmed and paid\"]}');");
            $setup->getConnection()->query("INSERT INTO `workflow_component_definition_parameters` (`workflowcomponentdefinitionparameters_id`, `component_id`, `name`, `type`, `required`, `enum_values`) VALUES (17, 6, 'export_path', 'text', 1, NULL);");
            ...
            $setup->getConnection()->query("INSERT INTO `workflow_component_schedule_relation` (`workflowcomponentschedulerelation_id`, `schedule_id`, `asynchron`, `component_id`, `position`, `parameters`) VALUES (6, 3, 0, 4, 2, '{\"ftp_host\":\"202.181.236.121\",\"ftp_user\":\"integration\",\"ftp_pw\":\"cleargoisthebest\",\"secure_type\":\"no-ssl\",\"file_pattern\":\"^shipment_[Ymd.xml\",\"upload_path\":\"/k11/dev/\"}');");
