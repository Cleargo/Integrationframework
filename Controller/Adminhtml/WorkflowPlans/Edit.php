...
class Edit extends \Cleargo\Integrationframeworks\Controller\Adminhtml\WorkflowPlans
{
    ...
    public function execute()
    {
        ...
        $this->_coreRegistry->register('cleargo_integrationframeworks_workflowplans', $model);
